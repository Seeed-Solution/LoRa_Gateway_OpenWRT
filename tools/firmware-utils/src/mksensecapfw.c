 ...
 *
 * This tool encrypts and decrypts uImage formatted firmware for SenseCAP
 * M2-RM04 wireless modules.  It will also truncate a dump of mtd6 and make
